...
class EditProductServletTest {
    ...
    void doPostTest() throws IOException {
        ...
        Mockito.verify(productService, Mockito.times(1)).editProduct(Product.builder()
                .id(1)
                .name("name")
                .price(10.0)
                .creationDate(null)
    ...
    void doPostTestReturnsException() throws IOException {
        ...
        Mockito.doThrow(new RuntimeException("exception")).when(productService).editProduct(test);
        editProductServlet.doPost(httpServletRequest, httpServletResponse);
