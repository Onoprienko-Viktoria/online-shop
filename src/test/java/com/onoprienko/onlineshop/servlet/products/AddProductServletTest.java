...
class AddProductServletTest {
    ...
    void doPostTest() throws IOException {
        ...
        Mockito.verify(productService, Mockito.times(1)).addProduct(Product.builder()
                .id(0)
                .name("test")
                .price(10.0)
                .creationDate(null)
    ...
    void doPostTestReturnsException() throws IOException {
        ...
        Mockito.doThrow(new RuntimeException("exception")).when(productService).addProduct(test);
        addProductServlet.doPost(httpServletRequest, httpServletResponse);
